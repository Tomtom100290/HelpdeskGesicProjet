 ...
 */
final class Version20260609120733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_97A0ADA3C3534552 ON ticket');
        $this->addSql('ALTER TABLE ticket ADD statut VARCHAR(255) NOT NULL, DROP id_statut');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD id_statut INT NOT NULL, DROP statut');
        $this->addSql('CREATE INDEX IDX_97A0ADA3C3534552 ON ticket (id_statut)');
