 ...
 */
final class Version20260609185457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_97A0ADA3C9486A13 ON ticket');
        $this->addSql('ALTER TABLE ticket DROP id_categorie');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD id_categorie INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_97A0ADA3C9486A13 ON ticket (id_categorie)');
