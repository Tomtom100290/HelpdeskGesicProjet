 ...
 */
final class Version20260713203527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD image_profil VARCHAR(80) DEFAULT NULL, ADD image_profil_size INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP image_profil, DROP image_profil_size, DROP updated_at');
    }
}
