 ...
 */
final class Version20260706052926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tache CHANGE id_utilisateur_assign id_utilisateur_assign INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tache CHANGE id_utilisateur_assign id_utilisateur_assign INT NOT NULL');
